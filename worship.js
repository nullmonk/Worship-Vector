...
// include: /tmp/tmpgy7ifthu.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'dist/worship.data';
      var REMOTE_PACKAGE_BASE = 'worship.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_dist/worship.data');
      }
      Module['addRunDependency']('datafile_dist/worship.data');
    ...
    loadPackage({"files": [{"filename": "/Beep.wav", "start": 0, "end": 11436}, {"filename": "/Click.wav", "start": 11436, "end": 23704}, {"filename": "/DataSmasher.ogg", "start": 23704, "end": 354169}, {"filename": "/Defense.ogg", "start": 354169, "end": 680015}, {"filename": "/MainControl.ogg", "start": 680015, "end": 951971}, {"filename": "/Order.wav", "start": 951971, "end": 988815}, {"filename": "/Victory.wav", "start": 988815, "end": 1058619}], "remote_package_size": 1058619});

  })();

// end include: /tmp/tmpgy7ifthu.js
// include: /tmp/tmpaidvjv0s.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpaidvjv0s.js
// include: /tmp/tmpqthzy080.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpqthzy080.js
...
function findWasmBinary() {
  return locateFile('worship.wasm');
}
...
var ASM_CONSTS = {
  425276: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 425491: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 425638: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
